...
SWIFT_MODULE_NAMESPACE_PUSH("RESTFrameworkGD")
...
SWIFT_CLASS("_TtC15RESTFrameworkGD15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(RESTFrameworkGD)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(RESTFrameworkGD)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(RESTFrameworkGD)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(RESTFrameworkGD)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(RESTFrameworkGD)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC15RESTFrameworkGD12TaskDelegate")
