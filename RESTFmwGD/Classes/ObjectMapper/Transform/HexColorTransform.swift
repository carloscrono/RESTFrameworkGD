...
//  ObjectMapper
//
//  Created by Grupo GD on 10/10/16.
//
    ...
    fileprivate func getColor(hex: String) -> Object? {
      ...
      if scanner.scanHexInt64(&hexValue) {
        ...
        case 4:
          ...
          intAlpha = CGFloat(hexValue & 0x000F)             / 15.0
        case 6:
        ...
        case 8:
          ...
          intAlpha = CGFloat(hexValue & 0x000000FF)         / 255.0
        default:
      ...
      #if os(iOS) || os(tvOS) || os(watchOS)
        return UIColor(red: red, green: green, blue: blue, alpha: intAlpha)
      #else
