...
public struct DataResponseSerializer<V>: DataResponseSerializerProtocol {
  /// The type of serialized object to be created by this `DataResponseSerializer`.
  public typealias SerializedObject = V
  
  /// A closure used by response handlers that takes a request, response, data and error and returns a result.
  public var serializeResponse: (URLRequest?, HTTPURLResponse?, Data?, Error?) -> Result<V>
  ...
  public init(serializeResponse: @escaping (URLRequest?, HTTPURLResponse?, Data?, Error?) -> Result<V>) {
...
public struct DownloadResponseSerializer<V>: DownloadResponseSerializerProtocol {
  /// The type of serialized object to be created by this `DownloadResponseSerializer`.
  public typealias SerializedObject = V
  
  /// A closure used by response handlers that takes a request, response, url and error and returns a result.
  public var serializeResponse: (URLRequest?, HTTPURLResponse?, URL?, Error?) -> Result<V>
  ...
  ///
  /// - returns: The new generic response serializer instance.
  public init(serializeResponse: @escaping (URLRequest?, HTTPURLResponse?, URL?, Error?) -> Result<V>) {
    self.serializeResponse = serializeResponse
  }
}
...
extension Request {
  ...
  public static func serializeResponseData(response: HTTPURLResponse?, data: Data?, error: Error?) -> Result<Data> {
    ...
    guard let validData = data else {
      return .failure(GDError.responseSerializationFailed(reason: .inputDataNil))
    }
  ...
  public static func dataResponseSerializer() -> DownloadResponseSerializer<Data> {
    return DownloadResponseSerializer { _, response, fileURL, error in
      ...
      guard let fileURL = fileURL else {
        return .failure(GDError.responseSerializationFailed(reason: .inputFileNil))
      }
      ...
      do {
        ...
        return .failure(GDError.responseSerializationFailed(reason: .inputFileReadFailed(at: fileURL)))
      }
    }
  }
...
extension Request {
    ...
    -> Result<String>
  {
    ...
    if let string = String(data: validData, encoding: actualEncoding) {
      ...
      return .failure(GDError.responseSerializationFailed(reason: .stringSerializationFailed(encoding: actualEncoding)))
    }
  }
}
...
extension Request {
    ...
    -> Result<Any>
  {
    ...
    guard let validData = data, validData.count > 0 else {
      return .failure(GDError.responseSerializationFailed(reason: .inputDataNilOrZeroLength))
    }
    ...
    do {
      ...
      return .failure(GDError.responseSerializationFailed(reason: .jsonSerializationFailed(error: error)))
    }
  }
}
...
extension Request {
    ...
    -> Result<Any>
  {
    ...
    do {
      ...
      return .failure(GDError.responseSerializationFailed(reason: .propertyListSerializationFailed(error: error)))
    }
  }
}
